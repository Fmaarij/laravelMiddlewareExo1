    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/accueil') }}"
                        class="ml-4  text-sm text-gray-700 dark:text-gray-500 underline">Accueil</a>
                    {{-- {{ dd($users) }} --}}
                    <a href="{{ url('/articles') }}"
                        class="ml-4  text-sm text-gray-700 dark:text-gray-500 underline">Articles</a>
                    {{-- @if ($users->role == 'webmaster') --}}
                        <a href="{{ url('/users') }}"
                            class="ml-4  text-sm text-gray-700 dark:text-gray-500 underline">Users</a>
                    {{-- @endif --}}
                    <a href="{{ url('createarticle') }}"
                        class="ml-4  text-sm text-gray-700 dark:text-gray-500 underline">Create Article</a>
                @else
                    <a href="{{ url('/accueil') }}"
                        class=" ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Accueil</a>
                    <a href="{{ url('/articles') }}"
